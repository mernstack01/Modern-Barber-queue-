...
import { makeRefreshToken, signAccessToken, verifyAccessToken, type AuthUser } from "@/server/auth";
...
export async function handleServerRequest(request: NextRequest, context: RouteContext) {
  try {
